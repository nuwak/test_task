...
Добавил такое выражение last_id+0 т.к. db-fiddle.com сглючил, вернул в поле FROM непонятные данные. На локальной машине запрос нормально отрабатывает без этого хака.
